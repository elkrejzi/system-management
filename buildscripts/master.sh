...
export DEFAULT_CFLAGS="-march=skylake -fomit-frame-pointer -Os -pipe"
export DEFAULT_CXXFLAGS="-march=skylake -fomit-frame-pointer -Os -pipe"

export DEFAULT_DEBUG_CFLAGS="-march=skylake -g -Os -pipe"
export DEFAULT_DEBUG_CXXFLAGS="-march=skylake -g -Os -pipe"
